// Scene 3 shows examples/Minimal.schema.json on screen. It is inlined in
// src/copy.ts because the video bundle cannot read outside its own tree, so this
// asserts the two have not drifted. This check is the reason the explainer lives
// in this repo rather than a standalone one.
...
// Both sides are newline-normalised. A Windows checkout has CRLF in copy.ts while
// examples/ may be LF; the comparison is about content, not line endings.
