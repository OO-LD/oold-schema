...
- [From JSON Schema](from-json-schema.md) - you already describe structure; add meaning.
- [From RDF, in particular JSON-LD](from-rdf.md) - you already describe meaning; add structure and validation.
- [From OWL or SHACL](from-owl-shacl.md) - realize an ontology class and constrain relations.
