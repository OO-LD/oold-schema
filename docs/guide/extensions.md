...
Furthermore, this notation can be used for data transformation and normalization As an example a dataset could consist of persons and organizations that report their relations in a syntactically non-interoperable way:
